    ...
    <div class="row">
      <div class="col-md-8 m-auto mt-4 border-0 rounded shadow">
              ...
              <form action="../function/auth.php" method="POST">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Special Field</label>
                    <input type="text" class="form-control" name="study" id="exampleFormControlInput1" placeholder="e.g software, hardware etc">
                </div>
                ...
                <button class="btn btn-primary mt-2 py-2 mb-3" name="add_cat">Submit</button>
